...
#define CONFIG_ENABLE_BT_SAMPLE 1
#define CONFIG_SAMPLE_SUPPORT_SLE_SAMPLE 1
#define CONFIG_SAMPLE_SUPPORT_SLE_SPEED_SERVER_SAMPLE 1
#define CONFIG_LARGE_THROUGHPUT_SERVER 1
