...
{
    uapi_pin_set_mode(S_MGPIO7, PIN_MODE_4);
    uapi_pin_set_mode(S_MGPIO9, PIN_MODE_4);// I2S_DO
    uapi_pin_set_mode(S_MGPIO10, PIN_MODE_4);//	I2S_SCLK
    uapi_pin_set_mode(S_MGPIO11, PIN_MODE_4);// I2S_LRCLK
    uapi_pin_set_mode(S_MGPIO12, PIN_MODE_4);// I2S_DI
...
uint32_t sio_porting_get_bclk_div_num(uint8_t data_width, uint32_t ch)
{
    ...
    middle_div = s_clk / (freq_of_need * actual_bit_width * ch);
